...
class TestWhisperTranscriber:
    ...
    def test_transcribe_api(self, mock_openai):
        ...
        # Setup mock API response as an object with attributes
        mock_response = Mock()
        mock_response.text = "API transcription result"
        mock_response.language = "en"
        mock_response.duration = 5.0
        mock_response.segments = []
        mock_openai.OpenAI.return_value.audio.transcriptions.create.return_value = mock_response
        ...
        assert mock_openai.OpenAI.return_value.audio.transcriptions.create.called
    ...
    def test_transcribe_api_with_language(self, mock_openai):
        ...
        call_args = mock_openai.OpenAI.return_value.audio.transcriptions.create.call_args
