...
class TestAudioPreprocessor:
    ...
    def test_initialization(self):
        ...
        preprocessor = AudioPreprocessor(sample_rate=16000, channels=1, bit_rate="16k")
    ...
    def test_normalize_audio_success(self, mock_run, preprocessor, temp_audio_file):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("pathlib.Path.exists") as mock_exists:
                ...
                result = preprocessor.normalize_audio(temp_audio_file, output_path=output_path, apply_noise_reduction=True)
    ...
    def test_convert_to_wav(self, mock_run, preprocessor, temp_audio_file):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("pathlib.Path.exists") as mock_exists:
                ...
                result = preprocessor.convert_to_wav(temp_audio_file, output_path=output_path)
