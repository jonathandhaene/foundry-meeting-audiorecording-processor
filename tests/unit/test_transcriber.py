...
from meeting_processor.transcription import AzureSpeechTranscriber, TranscriptionSegment, TranscriptionResult
...
def transcriber(mock_speech_sdk):
    ...
    return AzureSpeechTranscriber(speech_key="test_key", speech_region="test_region", language="en-US")
...
class TestTranscriptionSegment:
    ...
    def test_create_segment(self):
        ...
        segment = TranscriptionSegment(
            text="Hello world", start_time=0.0, end_time=1.5, speaker_id="speaker1", confidence=0.95
        )
    ...
    def test_segment_to_dict(self):
        ...
        segment = TranscriptionSegment(text="Test", start_time=0.0, end_time=1.0)
...
class TestTranscriptionResult:
    ...
    def test_create_result(self):
        ...
        segments = [TranscriptionSegment("Hello", 0.0, 1.0), TranscriptionSegment("World", 1.0, 2.0)]

        result = TranscriptionResult(
            segments=segments, full_text="Hello World", duration=2.0, language="en-US", metadata={"test": "value"}
        )
    ...
    def test_result_to_dict(self):
        ...
        result = TranscriptionResult(segments=segments, full_text="Test", duration=1.0, language="en-US", metadata={})
...
class TestAzureSpeechTranscriber:
    ...
    def test_initialization(self, mock_speech_sdk):
        ...
        transcriber = AzureSpeechTranscriber(
            speech_key="test_key", speech_region="test_region", language="en-US", enable_diarization=True, max_speakers=5
        )
    ...
    def test_custom_terms_initialization(self, mock_speech_sdk):
        ...
        transcriber = AzureSpeechTranscriber(speech_key="test_key", speech_region="test_region", custom_terms=custom_terms)
    ...
    def test_language_candidates_initialization(self, mock_speech_sdk):
        ...
        transcriber = AzureSpeechTranscriber(
            speech_key="test_key", speech_region="test_region", language_candidates=language_candidates
        )
