...
def main():
    ...
    print("6. HuggingFace Wav2Vec 2.0 transcription (via Inference API):")
    print()
    print("   from meeting_processor.transcription.hf_transcriber import HuggingFaceTranscriber")
    print()
    print("   # Using HuggingFace Inference API (set HUGGINGFACE_API_TOKEN in env)")
    print("   transcriber = HuggingFaceTranscriber(")
    print("       model_name='facebook/wav2vec2-base-960h',")
    print("       use_api=True,")
    print("   )")
    print("   result = transcriber.transcribe_audio('meeting.wav')")
    print("   print(result.full_text)")
    print()
    print("   # Using a Foundry-deployed inference endpoint")
    print("   transcriber = HuggingFaceTranscriber(")
    print("       model_name='facebook/wav2vec2-large-xlsr-53',  # multilingual")
    print("       endpoint_url='https://your-foundry-endpoint/score',")
    print("   )")
    print()
    print("   # Using a local Wav2Vec 2.0 model (requires: pip install transformers torch soundfile)")
    print("   transcriber = HuggingFaceTranscriber(")
    print("       model_name='facebook/wav2vec2-base-960h',")
    print("       use_api=False,")
    print("   )")
